...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente }) => {
    ...
    const handleSubmit = (e)=>{
       ...
       // Objeto paciente para recoger los datos 
    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5 " >
        ...
        <p className="text-lg mt-5 text-center mb-10 " >Agrega Pacientes y <span className="text-orange-700 font-bold" >Administralos</span></p>  
        ...
        className="bg-white shadow-lg rounded-lg py-10 px-5 mb-5" >
            ...
            <input
                type="submit"
                className="bg-orange-500 w-full p-3 text-white uppercase font-bold hover:bg-orange-400 cursor-pointer transition-all "
